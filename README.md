...
<div class="grid-container">
  ...
  <div class="card">
    ...
    <ul>
      ...
      <li>Tailwind CSS, Material-UI, Chakra UI, Redux</li>
      <li>Vector Databases: Elastic, Weaviate, Milvus</li>
      <li>LLM Integration: OpenAI, Claude, Gemini, DeepSeek</li>
      <li>LangChain, RAG Pipelines</li>
      <li>Git, GitHub, GitLab, Docker</li>
      <li>CI/CD (GitHub Actions), Postman, Jira</li>
      <li>REST APIs, JWT, Swagger</li>
    </ul>
  </div>
